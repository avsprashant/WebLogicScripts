This repo contains control scripts which are helpful in managing the weblogic domains, node and managed servers state i.e. i.e. start | run | stop | restart | status.
